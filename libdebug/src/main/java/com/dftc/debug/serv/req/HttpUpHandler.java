 ...
 * 上传请求处理
 *
 * @waring 1) `Unsafe JavaScript attempt to access frame...` maybe occur in chrome, which caused by iframe way of `ajaxfileupload.js`.

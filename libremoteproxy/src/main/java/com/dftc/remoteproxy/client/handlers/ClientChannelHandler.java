package com.dftc.remoteproxy.client.handlers;

import com.dftc.remoteproxy.client.ClientChannelMannager;
import com.dftc.remoteproxy.client.listener.ChannelStatusListener;
import com.dftc.remoteproxy.client.listener.ProxyChannelBorrowListener;
import com.dftc.remoteproxy.protocol.Constants;
                ...
                if (future.isSuccess()) {
                    ...
                    ClientChannelMannager.borrowProxyChanel(proxyBootstrap, new ProxyChannelBorrowListener() {
                        ...
                        public void success(Channel channel) {
                            ...
                            proxyMessage.setUri(userId + "@" + Utils.CLIENT_KEY);

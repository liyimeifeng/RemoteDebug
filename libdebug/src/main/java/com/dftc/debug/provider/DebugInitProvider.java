 ...
 *
 */
package com.dftc.debug.provider;
...
import com.dftc.debug.DebugHelper;
...
public class DebugInitProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if ("com.dftc.debug.provider.DebugInitProvider".equals(providerInfo.authority)) {
